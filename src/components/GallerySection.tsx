...
export const GallerySection: React.FC = () => {
  ...
  const defaultGalleryImages = [
    { title: "Gondola Phase 2 Snow Peaks", location: "Gulmarg, 13,780 ft", category: "Snow & Mountains", url: "https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&w=1200&q=80" },
    { title: "Golden Hour Houseboats on Nigeen Lake", location: "Srinagar", category: "Lakes & Water", url: "https://images.unsplash.com/photo-1595815771614-ade9d652a65d?auto=format&fit=crop&w=1200&q=80" },
    { title: "Lidder River Pine Valley Trails", location: "Pahalgam", category: "Valleys & Pines", url: "https://images.unsplash.com/photo-1566837945700-30057527ade0?auto=format&fit=crop&w=1200&q=80" },
    { title: "Habba Khatoon Pyramid Peak", location: "Gurez Valley", category: "Offbeat & Hidden", url: "https://images.unsplash.com/photo-1486870591958-9b9d0d1dda99?auto=format&fit=crop&w=1200&q=80" }
  ];
  const galleryImages = websiteContent.galleryImages?.length ? websiteContent.galleryImages : defaultGalleryImages;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 pt-12 border-t border-slate-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {(websiteContent.travelStories?.length ? websiteContent.travelStories : travelStories).map((story) => (
              <div
                key={story.id}
